 ...
 * interface that implements the get and set of the physics engine.
 */
public abstract class AbstractGameModelWithPhysicsEngine extends AbstractGameModel implements GameModelWithPhysicsEngine {
